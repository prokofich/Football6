...
import com.example.football6.*
import com.example.football6.viewmodel.SplashViewModel
...
import com.example.football6.view.SplashActivity as SplashActivity1
...
class SplashActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Glide.with(this)
            .load("http://37.27.9.28/6/backgroundsplash.png")
            .into(id_splash)
    ...
    fun goToWeb(url:String) {
        CoroutineScope(Dispatchers.Main).launch {
            delay(3000)
            var intent = Intent(this@SplashActivity,WebActivity::class.java)
